...
const CartProduct = ({ product }) => {
    ...
    const { img, name, price, ratings, shipping, seller, _id } = product;
    const plus = () => {
        setValue(value + 1)
    }
    const minus = () => {
            ...
            <div className="col-12 col-lg-6">
                <div className="details">
                    ...
                    <div className="counter">
                        ...
                        <Link to={`/complete/${_id}`}><button className='btn btn-dark rounded-0 btn-200px orderBtn'>Order Now</button></Link>
                    </div>
                </div>
            </div>
        </div>
